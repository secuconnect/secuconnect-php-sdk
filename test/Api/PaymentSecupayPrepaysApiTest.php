...
/**
 * PaymentSecupayPrepaysApiTest Class Doc Comment
 *
 * @category Class
 * @package  Secuconnect\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentSecupayPrepaysApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPaymentSecupayprepaysPost()
    {
        ...
        $this->assertInstanceOf(SecupayTransactionProductModelTransferAccount::class, $response->getTransferAccount());
    ...
    {
        try {
            $response = $this->api->paymentSecupayPrepaysGetById(self::$productId);
        } catch (\Secuconnect\Client\ApiException $e) {
            print_r($e->getResponseBody());
            throw $e;
        }
    ...
    {
        try {
            $response = $this->api->paymentSecupayPrepaysCancelById(self::$productId);
        } catch (\Secuconnect\Client\ApiException $e) {
            print_r($e->getResponseBody());
            throw $e;
        }
