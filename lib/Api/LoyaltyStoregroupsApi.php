...
class LoyaltyStoregroupsApi
{
     ...
     *
     * @param \Secuconnect\Client\Model\LoyaltyStoregroupsDTO $body Loyalty store group properties 
    ...
    public function getOneWithHttpInfo($loyalty_store_group_id)
    {
        ...
        if ($loyalty_store_group_id === null || (is_array($loyalty_store_group_id) && count($loyalty_store_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyalty_store_group_id when calling getOne'
            );
        }
        // parse inputs
    ...
    public function removeStoreGroupWithHttpInfo($loyalty_store_group_id)
    {
        ...
        if ($loyalty_store_group_id === null || (is_array($loyalty_store_group_id) && count($loyalty_store_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyalty_store_group_id when calling removeStoreGroup'
            );
        }
        // parse inputs
        $resourcePath = "/Loyalty/StoreGroups/{loyaltyStoreGroupId}";
    ...
    public function updateStoreGroupWithHttpInfo($loyalty_store_group_id, $body)
    {
        ...
        if ($loyalty_store_group_id === null || (is_array($loyalty_store_group_id) && count($loyalty_store_group_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $loyalty_store_group_id when calling updateStoreGroup'
            );
        }
        // parse inputs
        $resourcePath = "/Loyalty/StoreGroups/{loyaltyStoreGroupId}";
