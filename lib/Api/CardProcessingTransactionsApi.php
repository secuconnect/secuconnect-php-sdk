 ...
 */
class CardProcessingTransactionsApi
{
    /**
     * API Client
     *
     ...
     *
     * @return CardProcessingTransactionsApi
     */
     ...
     * @return \Secuconnect\Client\Model\CardprocessingTransactionsList
     */
     ...
     * @param string $expand Expand fields (all or a specific one) 
     * @throws ApiException on non-2xx response
     * @return array of \Secuconnect\Client\Model\CardprocessingTransactionsList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        // parse inputs
        $resourcePath = "/Cardprocessing/Transactions";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\CardprocessingTransactionsList',
                    '/Cardprocessing/Transactions'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\CardprocessingTransactionsList', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\CardprocessingTransactionsList', $e->getResponseHeaders());
     ...
     *
     * @param string $cardprocessing_transaction_id Card Processing Transaction ID (required)
     * @param string $expand Expand fields (all or a specific one) 
     * @throws ApiException on non-2xx response
    ...
    public function getOneWithHttpInfo($cardprocessing_transaction_id, $expand = null)
    {
        ...
        if ($cardprocessing_transaction_id === null || (is_array($cardprocessing_transaction_id) && count($cardprocessing_transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cardprocessing_transaction_id when calling getOne'
            );
        }
        // parse inputs
        $resourcePath = "/Cardprocessing/Transactions/{cardprocessingTransactionId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        if ($cardprocessing_transaction_id !== null) {
            $resourcePath = str_replace(
                ...
                $this->apiClient->getSerializer()->toPathValue($cardprocessing_transaction_id),
                $resourcePath
            );
        }
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\CardprocessingTransactionsProductModel',
                    '/Cardprocessing/Transactions/{cardprocessingTransactionId}'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\CardprocessingTransactionsProductModel', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\CardprocessingTransactionsProductModel', $e->getResponseHeaders());
                        $e->setResponseObject($data);
                        break;
                    case 401:
                        if ($retries < 1) {
