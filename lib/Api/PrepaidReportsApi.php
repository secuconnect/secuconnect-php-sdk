...
class PrepaidReportsApi
{
     ...
     */
    public function getOne($prepaid_reports_id)
    {
        list($response) = $this->getOneWithHttpInfo($prepaid_reports_id);
        return $response;
    }
     ...
     */
    public function getOneWithHttpInfo($prepaid_reports_id)
    {
