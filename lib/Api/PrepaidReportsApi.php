...
class PrepaidReportsApi
{
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PrepaidReportsProductModel',
                    '/Prepaid/Reports'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PrepaidReportsProductModel', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PrepaidReportsProductModel', $e->getResponseHeaders());
     ...
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\PrepaidReportsList
     */
     ...
     * @param string $expand Expand fields (all or a specific one) 
     * @throws ApiException on non-2xx response
     * @return array of \Secuconnect\Client\Model\PrepaidReportsList, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PrepaidReportsList',
                    '/Prepaid/Reports'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PrepaidReportsList', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PrepaidReportsList', $e->getResponseHeaders());
                        $e->setResponseObject($data);
                        break;
                    case 401:
                        if ($retries < 1) {
     ...
     * @return \Secuconnect\Client\Model\PrepaidReportsProductModel
     */
    public function getOne($prepaid_reports_id, $expand = null)
    {
        list($response) = $this->getOneWithHttpInfo($prepaid_reports_id, $expand);
        return $response;
    }
     ...
     * @return array of \Secuconnect\Client\Model\PrepaidReportsProductModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOneWithHttpInfo($prepaid_reports_id, $expand = null)
    {
        // verify the required parameter 'prepaid_reports_id' is set
        if ($prepaid_reports_id === null || (is_array($prepaid_reports_id) && count($prepaid_reports_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $prepaid_reports_id when calling getOne'
            );
        }
        // parse inputs
        $resourcePath = "/Prepaid/Reports/{prepaidReportsId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        // path params
        if ($prepaid_reports_id !== null) {
            $resourcePath = str_replace(
                "{" . "prepaidReportsId" . "}",
                $this->apiClient->getSerializer()->toPathValue($prepaid_reports_id),
                $resourcePath
            );
        }
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $headerParams,
                    '\Secuconnect\Client\Model\PrepaidReportsProductModel',
                    '/Prepaid/Reports/{prepaidReportsId}'
                );
