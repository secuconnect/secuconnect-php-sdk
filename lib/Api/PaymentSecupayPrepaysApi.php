...
class PaymentSecupayPrepaysApi
{
     ...
     * @return object
     */
    public function paymentSecupayPrepaysCancelById($payment_prepay_id)
    {
        list($response) = $this->paymentSecupayPrepaysCancelByIdWithHttpInfo($payment_prepay_id);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentSecupayPrepaysCancelByIdWithHttpInfo($payment_prepay_id)
    {
        // verify the required parameter 'payment_prepay_id' is set
        if ($payment_prepay_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_prepay_id when calling paymentSecupayPrepaysCancelById');
        }
        // parse inputs
        $resourcePath = "/Payment/Secupayprepays/{paymentPrepayId}/cancel";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function paymentSecupayPrepaysGetByIdWithHttpInfo($payment_prepay_id)
    {
        // verify the required parameter 'payment_prepay_id' is set
        if ($payment_prepay_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_prepay_id when calling paymentSecupayPrepaysGetById');
        }
        // parse inputs
