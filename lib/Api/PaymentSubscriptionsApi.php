...
class PaymentSubscriptionsApi
{
     ...
     *
     * @return PaymentSubscriptionsApi
     */
    ...
    public function paymentSubscriptionGetByIdWithHttpInfo($payment_subscription_id, $expand = null)
    {
        ...
        if ($payment_subscription_id === null || (is_array($payment_subscription_id) && count($payment_subscription_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_subscription_id when calling paymentSubscriptionGetById'
            );
        }
        // parse inputs
        $resourcePath = "/Payment/Subscriptions/{paymentSubscriptionId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        if ($payment_subscription_id !== null) {
            $resourcePath = str_replace(
                ...
                $this->apiClient->getSerializer()->toPathValue($payment_subscription_id),
                $resourcePath
            );
        }
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PaymentSubscriptionsProductModel',
                    '/Payment/Subscriptions/{paymentSubscriptionId}'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PaymentSubscriptionsProductModel', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PaymentSubscriptionsProductModel', $e->getResponseHeaders());
     ...
     * @param string $expand Expand fields (all or a specific one) 
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\PaymentSubscriptionsList
     */
    public function paymentSubscriptionsGet($count = null, $offset = null, $fields = null, $q = null, $sort = null, $aggregate = null, $meta = null, $validate = null, $scroll_expire = null, $scroll_id = null, $preset = null, $expand = null)
    {
        list($response) = $this->paymentSubscriptionsGetWithHttpInfo($count, $offset, $fields, $q, $sort, $aggregate, $meta, $validate, $scroll_expire, $scroll_id, $preset, $expand);
        return $response;
    }
     ...
     * @param string $expand Expand fields (all or a specific one) 
     * @throws ApiException on non-2xx response
     * @return array of \Secuconnect\Client\Model\PaymentSubscriptionsList, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentSubscriptionsGetWithHttpInfo($count = null, $offset = null, $fields = null, $q = null, $sort = null, $aggregate = null, $meta = null, $validate = null, $scroll_expire = null, $scroll_id = null, $preset = null, $expand = null)
    {
        // parse inputs
        $resourcePath = "/Payment/Subscriptions";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PaymentSubscriptionsList',
                    '/Payment/Subscriptions'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PaymentSubscriptionsList', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PaymentSubscriptionsList', $e->getResponseHeaders());
                        $e->setResponseObject($data);
                        break;
                    case 401:
                        if ($retries < 1) {
