...
class PaymentTransactionsApi
{
    ...
    /**
     * @deprecated use cancel(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsIdCancelPost($payment_transaction_id, $body = null)
    {
        return $this->cancel($payment_transaction_id, $body);
    }

    /**
     * @deprecated use cancelWithHttpInfo(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsIdCancelPostWithHttpInfo($payment_transaction_id, $body = null)
    {
        return $this->cancelWithHttpInfo($payment_transaction_id, $body);
    }

    /**
     * @deprecated use getAll(); this method will be removed with version 1.0.0
     */
    ...
    /**
     * @deprecated use getAllWithHttpInfo(); this method will be removed with version 1.0.0
     */
    ...
    /**
     * @deprecated use getOne(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsGetById($payment_transaction_id)
    {
        return $this->getOne($payment_transaction_id);
    }
    /**
     * @deprecated use getOneWithHttpInfo(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsGetByIdWithHttpInfo($payment_transaction_id)
    {
        return $this->getOneWithHttpInfo($payment_transaction_id);
    }

    /**
     * @deprecated use getShippingUrl(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsIdShippingUrlGet($payment_transaction_id)
    {
        return $this->getShippingUrl($payment_transaction_id);
    }
    /**
     * @deprecated use getShippingUrlWithHttpInfo(); this method will be removed with version 1.0.0
     */
    public function paymentTransactionsIdShippingUrlGetWithHttpInfo($payment_transaction_id)
    {
        return $this->getShippingUrlWithHttpInfo($payment_transaction_id);
    }
}
