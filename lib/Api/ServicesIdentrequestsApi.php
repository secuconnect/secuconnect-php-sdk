...
class ServicesIdentrequestsApi
{
     ...
     */
    public function addIdentrequests($body)
    {
        list($response) = $this->addIdentrequestsWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function addIdentrequestsWithHttpInfo($body)
    {
        // parse inputs
        $resourcePath = "/Services/Identrequests";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel',
                    '/Services/Identrequests'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel', $e->getResponseHeaders());
     ...
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\ServicesIdentrequestsList
     */
     ...
     * @param string $preset Query presets 
     * @throws ApiException on non-2xx response
     * @return array of \Secuconnect\Client\Model\ServicesIdentrequestsList, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\ServicesIdentrequestsList',
                    '/Services/Identrequests'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\ServicesIdentrequestsList', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\ServicesIdentrequestsList', $e->getResponseHeaders());
                        $e->setResponseObject($data);
                        break;
                    case 401:
                        if ($retries < 1) {
    ...
    public function getOneWithHttpInfo($identrequest_id)
    {
        ...
        // parse inputs
        $resourcePath = "/Services/Identrequests/{identrequestId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $headerParams,
                    '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel',
                    '/Services/Identrequests/{identrequestId}'
                );
