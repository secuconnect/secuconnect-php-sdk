...
class PaymentCustomersApi
{
    ...
    public function paymentCustomersGetByIdWithHttpInfo($payment_customer_id)
    {
        ...
        if ($payment_customer_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_customer_id when calling paymentCustomersGetById');
        }
        // parse inputs
    ...
    public function paymentCustomersIdDeleteWithHttpInfo($payment_customer_id)
    {
        // verify the required parameter 'payment_customer_id' is set
        if ($payment_customer_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_customer_id when calling paymentCustomersIdDelete');
        }
        // parse inputs
        $resourcePath = "/Payment/Customers/{paymentCustomerId}";
        $httpBody = '';
    ...
    public function paymentCustomersIdPutWithHttpInfo($payment_customer_id, $body)
    {
        // verify the required parameter 'payment_customer_id' is set
        if ($payment_customer_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $payment_customer_id when calling paymentCustomersIdPut');
        }
