...
class PaymentPlansApi
{
    ...
    /**
     * Operation paymentPlansApiInterfacePatchPlans
     *
     ...
     */
    public function paymentPlansApiInterfacePatchPlans($payment_plan_id, $body)
    {
        list($response) = $this->paymentPlansApiInterfacePatchPlansWithHttpInfo($payment_plan_id, $body);
        return $response;
    }

    /**
     * Operation paymentPlansApiInterfacePatchPlansWithHttpInfo
     *
     * PATCH Payment/Plans/{paymentPlanId}
     *
     * @param string $payment_plan_id Payment plan id (required)
     ...
     */
    public function paymentPlansApiInterfacePatchPlansWithHttpInfo($payment_plan_id, $body)
    {
        ...
        if ($payment_plan_id === null || (is_array($payment_plan_id) && count($payment_plan_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_plan_id when calling paymentPlansApiInterfacePatchPlans'
            );
        }
        // parse inputs
    ...
    /**
     * Operation paymentPlansApiInterfaceUpdatePlans
     *
     ...
     * @return \Secuconnect\Client\Model\PaymentPlansProductModel
     */
    public function paymentPlansApiInterfaceUpdatePlans($payment_plan_id, $body)
    {
        list($response) = $this->paymentPlansApiInterfaceUpdatePlansWithHttpInfo($payment_plan_id, $body);
        return $response;
    }

    /**
     * Operation paymentPlansApiInterfaceUpdatePlansWithHttpInfo
     *
     * PUT Payment/Plans/{paymentPlanId}
     *
     * @param string $payment_plan_id Payment plan id (required)
     ...
     * @return array of \Secuconnect\Client\Model\PaymentPlansProductModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function paymentPlansApiInterfaceUpdatePlansWithHttpInfo($payment_plan_id, $body)
    {
        // verify the required parameter 'payment_plan_id' is set
        if ($payment_plan_id === null || (is_array($payment_plan_id) && count($payment_plan_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_plan_id when calling paymentPlansApiInterfaceUpdatePlans'
            );
        }
        // parse inputs
        $resourcePath = "/Payment/Plans/{paymentPlanId}";
