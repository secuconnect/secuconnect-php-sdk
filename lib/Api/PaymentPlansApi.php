...
class PaymentPlansApi
{
     ...
     */
    public function patchPlans($payment_plan_id, $body)
    {
        list($response) = $this->patchPlansWithHttpInfo($payment_plan_id, $body);
        return $response;
    }

    /**
     * Operation patchPlansWithHttpInfo
     *
     * PATCH Payment/Plans/{paymentPlanId}
     *
     * @param string $payment_plan_id Payment plan id (required)
     ...
     */
    public function patchPlansWithHttpInfo($payment_plan_id, $body)
    {
        ...
        if ($payment_plan_id === null || (is_array($payment_plan_id) && count($payment_plan_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_plan_id when calling patchPlans'
            );
        }
        // parse inputs
     ...
     * @return \Secuconnect\Client\Model\PaymentPlansProductModel
     */
    public function updatePlans($payment_plan_id, $body)
    {
        list($response) = $this->updatePlansWithHttpInfo($payment_plan_id, $body);
        return $response;
    }
     ...
     * @return array of \Secuconnect\Client\Model\PaymentPlansProductModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePlansWithHttpInfo($payment_plan_id, $body)
    {
        // verify the required parameter 'payment_plan_id' is set
        if ($payment_plan_id === null || (is_array($payment_plan_id) && count($payment_plan_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_plan_id when calling updatePlans'
            );
        }
        // parse inputs
        $resourcePath = "/Payment/Plans/{paymentPlanId}";
