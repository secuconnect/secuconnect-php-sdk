...
class PaymentContainersApi
{
    ...
    /**
     * Operation execMandatePost
     *
     * POST Payment/Containers/<id>/mandate
     *
     * @param \Secuconnect\Client\Model\MandateDTO $body Get an B2B mandate form properties (optional)
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\MandateProductModel
     */
    public function execMandatePost($body)
    {
        list($response) = $this->execMandatePostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation execMandatePostWithHttpInfo
     *
     * POST Payment/Containers/<id>/mandate
     *
     * @param \Secuconnect\Client\Model\MandateDTO $body Get an B2B mandate form properties (optional)
     ...
     */
    public function execMandatePostWithHttpInfo($body)
    {
        // parse inputs
    ...
    /**
     * Operation execUploadmandatePost
     *
     * POST Payment/Containers/<id>/Uploadmandate
     *
     * @param \Secuconnect\Client\Model\UploadmandateDTO $body Signed B2B mandate properties (optional)
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\UploadmandateProductModel
     */
    public function execUploadmandatePost($body)
    {
        list($response) = $this->execUploadmandatePostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation execUploadmandatePostWithHttpInfo
     *
     * POST Payment/Containers/<id>/Uploadmandate
     *
     * @param \Secuconnect\Client\Model\UploadmandateDTO $body Signed B2B mandate properties (optional)
     ...
     */
    public function execUploadmandatePostWithHttpInfo($body)
    {
        // parse inputs
     ...
     *
     * @param string $payment_container_id Payment container id (required)
     * @param \Secuconnect\Client\Model\PaymentContainersDTO $body Payment container properties (optional)
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\PaymentContainersProductModel
     */
