...
class PaymentMandatesApi
{
     ...
     */
    public function addMandates($body)
    {
        list($response) = $this->addMandatesWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function addMandatesWithHttpInfo($body)
    {
        // parse inputs
        $resourcePath = "/Payment/Mandates";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PaymentMandatesProductModel',
                    '/Payment/Mandates'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PaymentMandatesProductModel', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PaymentMandatesProductModel', $e->getResponseHeaders());
     ...
     * @return void
     */
    public function execBulk($body)
    {
        $this->execBulkWithHttpInfo($body);
    }
     ...
     */
    public function execBulkWithHttpInfo($body)
    {
        // parse inputs
        $resourcePath = "/Payment/Mandates/me/bulk";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     * @throws ApiException on non-2xx response
     * @return \Secuconnect\Client\Model\PaymentMandatesList
     */
     ...
     * @param string $preset Query presets 
     * @throws ApiException on non-2xx response
     * @return array of \Secuconnect\Client\Model\PaymentMandatesList, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $httpBody,
                    $headerParams,
                    '\Secuconnect\Client\Model\PaymentMandatesList',
                    '/Payment/Mandates'
                );

                return [$this->apiClient->getSerializer()->deserialize($response, '\Secuconnect\Client\Model\PaymentMandatesList', $httpHeader), $statusCode, $httpHeader];
            } catch (ApiException $e) {
                switch ($e->getCode()) {
                    case 200:
                        $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Secuconnect\Client\Model\PaymentMandatesList', $e->getResponseHeaders());
                        $e->setResponseObject($data);
                        break;
                    case 401:
                        if ($retries < 1) {
    ...
    public function getOneWithHttpInfo($payment_mandates_id)
    {
        ...
        if ($payment_mandates_id === null || (is_array($payment_mandates_id) && count($payment_mandates_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_mandates_id when calling getOne'
            );
        }
        // parse inputs
        $resourcePath = "/Payment/Mandates/{paymentMandatesId}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        if ($payment_mandates_id !== null) {
            $resourcePath = str_replace(
                "{" . "paymentMandatesId" . "}",
                $this->apiClient->getSerializer()->toPathValue($payment_mandates_id),
                $resourcePath
            );
        }
        ...
        for ($retries = 0; ; $retries++) {
            ...
            try {
                list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                    ...
                    $headerParams,
                    '\Secuconnect\Client\Model\PaymentMandatesProductModel',
                    '/Payment/Mandates/{paymentMandatesId}'
                );
