...
/**
 * PaymentSecupayInvoicesApi Class Doc Comment
 *
 * @category Class
 * @package  Secuconnect\Client
 * @author   Swagger Codegen team
...
class PaymentSecupayInvoicesApi
{
     ...
     * @return object
     */
    public function paymentSecupayInvoicesCancelById($hash)
    {
        list($response) = $this->paymentSecupayInvoicesCancelByIdWithHttpInfo($hash);
        return $response;
    }
     ...
     */
    public function paymentSecupayInvoicesCancelByIdWithHttpInfo($hash)
    {
        // verify the required parameter 'hash' is set
        if ($hash === null) {
            throw new \InvalidArgumentException('Missing the required parameter $hash when calling paymentSecupayInvoicesCancelById');
        }
        // parse inputs
        $resourcePath = "Payment/Secupayinvoices/{hash}/cancel";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
     ...
     */
    public function paymentSecupayInvoicesGetById($hash)
    {
        list($response) = $this->paymentSecupayInvoicesGetByIdWithHttpInfo($hash);
        return $response;
    }
     ...
     */
    public function paymentSecupayInvoicesGetByIdWithHttpInfo($hash)
    {
        // verify the required parameter 'hash' is set
        if ($hash === null) {
            throw new \InvalidArgumentException('Missing the required parameter $hash when calling paymentSecupayInvoicesGetById');
        }
        // parse inputs
        $resourcePath = "Payment/Secupayinvoices/{hash}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
