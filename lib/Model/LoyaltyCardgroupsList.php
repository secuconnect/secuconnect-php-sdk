 ...
 */
class LoyaltyCardgroupsList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoyaltyCardgroupsList';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
        'data' => '\Secuconnect\Client\Model\LoyaltyCardgroupsProductModel[]',
        'scroll_id' => 'string',
        'result' => 'bool',
        'meta' => 'object',
        'type' => 'string',
    ...
    /**
     * Sets count
     * @param int $count Number of matching Loyalty Card Groups
     * @return $this
     */
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\LoyaltyCardgroupsProductModel[] $data Loyalty Card Groups (limited number)
     * @return $this
     */
