 ...
 */
class PaymentTransactionsList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentTransactionsList';
    ...
    /**
     * Sets count
     * @param int $count Number of existing payment transactions
     * @return $this
     */
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\PaymentTransactionsProductModel[] $data List of PaymentTransactions
     * @return $this
     */
