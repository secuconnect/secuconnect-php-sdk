 ...
 */
class SmartTemplatesAccordionItemModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SmartTemplatesAccordionItemModel';
    ...
    /**
     * Sets elements
     * @param \Secuconnect\Client\Model\SmartTemplatesElementModel[] $elements The child elements to be shown inside an accordion item
     * @return $this
     */
