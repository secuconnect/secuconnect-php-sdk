 ...
 */
class LoyaltyMerchantcardsList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoyaltyMerchantcardsList';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
        'data' => '\Secuconnect\Client\Model\LoyaltyMerchantcardsProductModel[]',
        'scroll_id' => 'string',
        'result' => 'bool',
        'meta' => 'object',
        'type' => 'string',
    ...
    /**
     * Sets count
     * @param int $count Number of matching Loyalty Merchant Cards
     * @return $this
     */
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\LoyaltyMerchantcardsProductModel[] $data Loyalty Merchant Cards (limited number)
     * @return $this
     */
