 ...
 */
class GetSmartDevicePinConfigSmartDevice implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSmartDevicePinConfig_smart_device';
    ...
    /**
     * Sets id
     * @param string $id Smart Devices ID
     * @return $this
     */
