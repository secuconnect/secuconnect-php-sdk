 ...
 */
class PaymentMandatesList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentMandatesList';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
        'data' => '\Secuconnect\Client\Model\PaymentMandatesProductModel[]',
        'scroll_id' => 'string',
        'result' => 'bool',
        'meta' => 'object',
        'type' => 'string',
    ...
    /**
     * Sets count
     * @param int $count Number of existing payment mandates
     * @return $this
     */
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\PaymentMandatesProductModel[] $data List of Payment Mandates
     * @return $this
     */
