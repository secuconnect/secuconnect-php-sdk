 ...
 */
class PaymentContainersList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentContainersList';
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\PaymentContainersProductModel[] $data GET Payment/Containers
     * @return $this
     */
