 ...
 */
class PrepaidReportsList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrepaidReportsList';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
        'data' => '\Secuconnect\Client\Model\PrepaidReportsProductModel[]',
        'scroll_id' => 'string',
        'result' => 'bool',
        'meta' => 'object',
        'type' => 'string',
    ...
    /**
     * Sets count
     * @param int $count Total number of matching Prepaid Reports
     * @return $this
     */
    ...
    /**
     * Sets data
     * @param \Secuconnect\Client\Model\PrepaidReportsProductModel[] $data Prepaid Reports (limited number)
     * @return $this
     */
