 ...
 */
class ServicesIdentrequestsList implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServicesIdentrequestsList';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
        'data' => '\Secuconnect\Client\Model\ServicesIdentrequestsProductModel[]',
        'scroll_id' => 'string',
        'result' => 'bool',
        'meta' => 'object',
        'type' => 'string',
    ...
    /**
     * Sets count
     * @param int $count Number of existing identrequests
     * @return $this
     */
