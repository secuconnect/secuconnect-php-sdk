...
------------- | ------------- | -------------
[**paymentCustomersGet**](PaymentCustomersApi.md#paymentCustomersGet) | **GET** Payment/Customers | 
[**paymentCustomersGetById**](PaymentCustomersApi.md#paymentCustomersGetById) | **GET** Payment/Customers/{id} | 
[**paymentCustomersIdDelete**](PaymentCustomersApi.md#paymentCustomersIdDelete) | **DELETE** Payment/Customers/{id} | 
[**paymentCustomersIdPut**](PaymentCustomersApi.md#paymentCustomersIdPut) | **PUT** Payment/Customers/{id} | 
[**paymentCustomersPost**](PaymentCustomersApi.md#paymentCustomersPost) | **POST** Payment/Customers | 


# **paymentCustomersGet**
> \Secuconnect\Client\Model\InlineResponse2003 paymentCustomersGet($count, $offset, $fields, $q, $sort)
...
[**\Secuconnect\Client\Model\InlineResponse2003**](../Model/InlineResponse2003.md)
...
> \Secuconnect\Client\Model\PaymentCustomersProductModel paymentCustomersGetById($id)
...
try {
    $result = $api_instance->paymentCustomersGetById($id);
    print_r($result);
} catch (Exception $e) {
...
> \Secuconnect\Client\Model\PaymentCustomersProductModel[] paymentCustomersIdDelete($id)
...
$api_instance = new Secuconnect\Client\Api\PaymentCustomersApi();
$id = "id_example"; // string | Payment customer id

try {
    $result = $api_instance->paymentCustomersIdDelete($id);
    print_r($result);
} catch (Exception $e) {
...
> \Secuconnect\Client\Model\PaymentCustomersProductModel paymentCustomersIdPut($id, $body)
...
try {
    $result = $api_instance->paymentCustomersIdPut($id, $body);
    print_r($result);
} catch (Exception $e) {
